...
3. ingresamos el siguiente script:
...
4. Quedandonos como en la imagen:<p align="left"><img height="150"  src="./Assets/ScreenShots/pgadmin.jpg" /><p>
   clickeamos el boton de "play" remarcado en rojo, en la parte inferior veremos un contador, unavez que finalize tendremos cargados los datos de los vuelos en la base de datos. Si todo saliocorrectamente deberiamos visualizar un mensaje como el siguiente:<p align="left"><img height="220"  src="./Assets/ScreenShots/finish.jpg" /><p>
